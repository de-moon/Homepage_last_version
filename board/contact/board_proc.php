...
include_once $_SERVER['DOCUMENT_ROOT']."/common/php/PHPMailer/class.phpmailer.php";
include_once $_SERVER['DOCUMENT_ROOT']."/common/php/PHPMailer/class.smtp.php";
include_once $_SERVER['DOCUMENT_ROOT']."/common/php/PHPMailer/PHPMailerAutoload.php";
