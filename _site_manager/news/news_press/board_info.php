...
$BOARD_EDITOR					= true;								// 내용 에디터 사용여부
$BOARD_CONTENT				= true;								// 내용
$BOARD_REG_DATE				= true;								// 등록일 수정여부
...
$BOARD_ETC_3						= false;								// 추가컬럼
$BOARD_ETC_2						= false;								// 추가컬럼
$BOARD_ETC_4						= false;								// 추가컬럼
$BOARD_ETC_5						= false;								// 추가컬럼
$BOARD_ETC_6						= false;								// 추가컬럼
