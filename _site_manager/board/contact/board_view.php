		...
		<div class="table_view_type01">
			...
			<table>
				...
				<tr <?php if (!$BOARD_ETC_6) { ?>style="display:none;"<?php } ?>>
					<th>이메일</th>
					<td class="tal"><a href="mailto:<?=$col_etc_6 ?>"><?=$col_etc_6 ?></a></td>
				</tr>
				...
				<tr <?php if ( sizeof($BOARD_CATEGORY) < 1 ) echo "style='display:none;'"; ?>>
					<th>답변여부</th>
					<td class="tal">
						<form name="frm_ins" method="post" enctype="multipart/form-data" action="board_proc.php" target="frm_hiddenFrame">
						...
						<select title="분류" name="category" onchange="setCategory();">
